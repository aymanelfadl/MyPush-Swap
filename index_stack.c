...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/18 17:44:34 by aelfadl           #+#    #+#             */
/*   Updated: 2025/02/18 17:44:37 by aelfadl          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_stack	*get_smallest_bigger_node(t_stack *stack, int index)
{
	...
	while (stack)
	{
		if (stack->index > index && (!smallest_bigger_node
				|| stack->index < smallest_bigger_node->index))
